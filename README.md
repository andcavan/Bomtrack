...
- **Colonne dell’elenco a scelta** — in Acquisti, Progetto e Magazzino un pulsante **Colonne** apre l’elenco delle colonne disponibili: quelle che non servono si tolgono, e restano tolte anche domani. Codice e nome non si nascondono, che sono l’identità della riga. Ogni elenco tiene la sua scelta — le due anagrafiche hanno le stesse colonne ma si guardano per motivi diversi — e ciò che sparisce dalla tabella resta nel pannello laterale. L’export Excel e PDF resta completo: esporta l’elenco, non la vista.
